...
/* USER CODE BEGIN PV */
#define TMP102_ADDRESS 0x48   // TMP102 I2C address (shifted by 1 internally)


#define TMP102_Reg    0x00     // Temperature register
#define TMP102_Tlow	  0x02    // Low temperature threshold register
#define TMP102_Thigh  0x01   // High temperature threshold register
#define TMP102_Con    0x03  // Configuration register
#define TMP102_Alert  0x01

// Private variables
uint8_t tempData[2];  // Array to store the two bytes of temperature data
float temperature;  // 16-bit signed temperature value
/* USER CODE END PV */
